...
// takes input from bundle (other activities)
    ...
    protected void onCreate(Bundle savedInstanceState) { // Bundle = initialize activity
        ...
        setContentView(R.layout.activity_farligt_affald); // setContentView is a connection with the layout from the connected activity.
        //Layout resource file defining UI
